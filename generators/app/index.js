...
module.exports = class extends Generator {
  prompting() {
    ...
    this.log(
      yosay(
        `Welcome to the best ${chalk.red("generator-minar-desktop")} generator!`
      )
    );
    ...
    var prompts = [
      {
        type: "input",
        name: "projectName",
        message: "Please input project name (minar-desktop):",
        default: "minar-desktop"
      },
      {
        type: "input",
        name: "projectDesc",
      ...
      },
      {
        type: "confirm",
        name: "electron",
        message: "Would you like to add Electron?"
      }
    ];
  ...
  writing() {
    ...
    pkg.keywords.push("minar-desktop");
    ...
    if (!this.props.electron) {
      ...
      delete pkg.main;
      delete pkg.scripts.electron;
      delete pkg.scripts["electron:build"];
    }
